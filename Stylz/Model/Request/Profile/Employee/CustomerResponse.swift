...
struct Customer: Codable {
  ...
  //  let dob: JSONNull?
    let age: Int?
 //   let image, avgSpent, totalSpent: JSONNull?
    let phone: String?
   // let group, branch, type: JSONNull?
    let createAt, updatedAt: String?

    enum CodingKeys: String, CodingKey {
        case id, gender, age
       // case dob, image
       // case avgSpent = "avg_spent"
       // case totalSpent = "total_spent"
        case phone
      //  case group, branch, type
